...
$smartphonesComDesconto = array_map(function($p) {
 // 1. Altere o valor de $p['preco'] dando o desconto
...
<body>
    ...
    <?php 
    // lista $smartphonesComDesconto 
     foreach ($smartphonesComDesconto as $produto): ?>
...
<!-- deixar comentado para n aparecer na página -->
    </pre>
